...
public class MatakuliahDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText edNim = (EditText) findViewById(R.id.editTextKodeMatkulDicari);
        Button btnHapus = (Button)findViewById(R.id.buttonHapusMatkul);
            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback<DefaultResult>() {
                    ...
                    public void onResponse(Call<DefaultResult> call, Response<DefaultResult> response) {
                        pd.dismiss();
                        Toast.makeText(MatakuliahDeleteActivity.this, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    ...
                    public void onFailure(Call<DefaultResult> call, Throwable t) {
                        pd.dismiss();
                        Toast.makeText(MatakuliahDeleteActivity.this, "Gagal", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
